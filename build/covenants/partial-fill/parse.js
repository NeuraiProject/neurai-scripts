 ...
 */
export function parsePartialFillScript(script, network = 'xna-test') {
    ...
    if (ASSETFIELD_AMOUNT !== 0x02)
        throw new Error('unexpected AMOUNT selector constant');
    ...
    if (ASSETFIELD_NAME !== 0x01)
        throw new Error('unexpected NAME selector constant');
